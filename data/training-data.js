...
const TRAINING = [
  ...
  },
  {
    ...
    department: "operations",
    areas: ALL_AREAS,
    // The master sheet leaves the Area blank for this one — treated as
    // whole-organisation. Narrow the `areas` list if that is wrong.
    audience: "Whole Organisation",
  ...
  },
  {
    ...
    type: "workshop",
    department: "operations",
    // The sheet files this under Operations, not Leadership. Change
    // `department` to "leadership" if it should sit there instead.
    areas: ["stores"],
    audience: "Corporate Stores",
    summary: "Develops the skills required to lead teams, manage performance and support employee development.",
    resources: "",
  },
